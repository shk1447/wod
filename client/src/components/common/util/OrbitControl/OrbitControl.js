...
var OrbitControl = function ( object, domElement ) {
    ...
    this.zoomOut = function(){
        if ( scope.object.isPerspectiveCamera ) {
            ...
            scope.object.zoom = Math.max( scope.minZoom, Math.min( scope.maxZoom, scope.object.zoom * this.zoomScale()) );
            scope.object.updateProjectionMatrix();
            zoomChanged = true;
...
Object.defineProperties( OrbitControl.prototype, {
